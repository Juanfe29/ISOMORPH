...
export default function GraphLandscape() {
    ...
    useEffect(() => {
        ...
        const moonNodes = createSphere(60, 140); // Moon
        ...
        const getElevation = (x: number, z: number, t: number) => {
            ...
            if (distFromCenter < 1000) {
                y -= (1000 - distFromCenter) * 0.2; 
            } else {
                y += (distFromCenter - 1000) * 0.3; 
            }
            return y;
        };
