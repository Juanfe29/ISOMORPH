        ...
        <section className="relative w-full py-16 md:py-32 bg-black overflow-hidden border-t border-white/5">
            ...
            <div className="container mx-auto px-6 relative z-10">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    >
                        <span className="text-[10px] uppercase tracking-[0.4em] text-white/55 font-mono mb-6 block">Our Vision</span>
                        ...
                        <p className="text-base md:text-2xl text-white/65 font-sans tracking-wide leading-relaxed mb-10 md:mb-16">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
                        ...
                        >
                            ...
                            <Cpu className="w-8 h-8 text-white/40 mb-6 relative z-10" />
                            <h3 className="text-xl font-display font-bold text-white mb-3 relative z-10">Desarrollo Aliado</h3>
                            <p className="text-sm text-white/65 leading-relaxed font-sans relative z-10">
